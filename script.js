...
var Point = function(){
  ...
  this.draw = function(context){
    ...
    for(i=0; i<this._neighboors.length; i++) {
        ...
        context.lineWidth = 0.30 + 5 / this._neighboors[i].distance;
    }
    context.closePath();
...
$('#fold').click(function(e) {
  $('.content').addClass("red").delay(400).queue(function(next){
...
// var btnContainer = document.getElementById("iconbar");
...
// function myFunction() {
//   var x = document.getElementById("iconbar");
